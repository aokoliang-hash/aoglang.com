...
function pictureTopicArticleSlug(p) {
  ...
  if (/smart-energy|microgrid|white-podium|product-display-three|minimalist-product|curved-wall|architectural-concrete/.test(slug)) {
    return "energy-product-display-gallery";
  }
  return null;
}
...
const ARTICLES = [
  ...
  },
  {
    ...
    zh: {
      ...
      desc: "解读 upload 新增 9 张能源电力与产品展示题材图：智慧能源、微电网储能、清水混凝土、白色展台与立方体陈列等，均有双语说明页并链到本专题。",
      tags: ["文章", "能源", "微电网", "产品展示", "图集", "SEO"],
      intro:
        "本站图集新增一批<strong>智慧能源与电商展示场景</strong>视觉，涵盖储能设备、EMS 系统、建筑材质特写与 3D 产品展台。下文按主题分组并链到对应单图页面；单图 URL 以分享为主，完整解读集中在本篇专题。",
      sections: [
        {
          h: "智慧能源与微电网",
          p: "智慧能源主题：<a href=\"../gallery/smart-energy-future-01.html\">智慧能源未来 01</a>、<a href=\"../gallery/smart-energy-future-02.html\">02</a>；微电网 EMS：<a href=\"../gallery/microgrid-ems-energy-01.html\">微电网 EMS 储能</a>；储能设备：<a href=\"../gallery/microgrid-storage-equipment-01.html\">微电网储能设备</a>。可与 <a href=\"../gallery/electric-grid-energy-lines.html\">电网能量流光</a>、<a href=\"tech-industry-visual-handbook.html\">科技工业手册</a> 互链。",
        },
        {
          h: "产品展示与极简空间",
        ...
        {
          h: "发布与 noindex 说明",
          p: "新图放入 <code>upload/picture/</code> 后执行 <code>npm run build</code> 即可生成 WebP 与双语页面。单图页默认 <code>noindex</code>，搜索权重由本篇等专题承载——详见 <a href=\"aoglang-site-seo-case-study.html\">站点 SEO 复盘</a>。",
        },
      ],
    },
    en: {
      title: "New energy & product-display gallery uploads",
      desc: "Nine new images—smart energy, microgrid storage, concrete texture, and minimalist product stages—with bilingual pages linked from this feature.",
      tags: ["article", "energy", "microgrid", "product display", "gallery", "SEO"],
      intro:
        "The gallery adds <strong>smart energy and e-commerce staging</strong> visuals—storage hardware, EMS systems, architectural textures, and 3D product pedestals. Single-image URLs are for sharing; this feature carries the SEO narrative.",
      sections: [
        {
          h: "Smart energy & microgrid",
          p: "See <a href=\"../gallery/smart-energy-future-01.html\">smart energy future 01</a>, <a href=\"../gallery/smart-energy-future-02.html\">02</a>, <a href=\"../gallery/microgrid-ems-energy-01.html\">microgrid EMS</a>, and <a href=\"../gallery/microgrid-storage-equipment-01.html\">storage equipment</a>—pair with <a href=\"../gallery/electric-grid-energy-lines.html\">electric grid lines</a> and the <a href=\"tech-industry-visual-handbook.html\">tech industry handbook</a>.",
        },
        {
        ...
        {
          h: "Publishing & noindex",
          p: "Drop files into <code>upload/picture/</code>, run <code>npm run build</code>. Gallery detail URLs are <code>noindex</code>—see our <a href=\"aoglang-site-seo-case-study.html\">SEO case study</a>.",
        },
      ],
    },
  },
...
async function optimizeGalleryImage(srcPath, destDir, basename) {
  ...
  for (const out of [mainPath, thumbPath]) {
...
async function syncUploadPictures() {
  ...
  for (const p of PICTURES) {
    ...
    if (fs.existsSync(mainPath) && !fs.existsSync(thumbPath)) {
      const mainMeta = await sharp(mainPath).metadata();
      const srcW = mainMeta.width || IMAGE_THUMB_MAX;
      const thumbW = Math.min(srcW, IMAGE_THUMB_MAX);
      ...
      p.w = mainMeta.width || p.w;
      p.h = mainMeta.height || p.h;
      console.log("thumb only", path.relative(root, thumbPath));
      continue;
    }
